...
Plugin::ReflectMaterial::ReflectMaterial(const Component::Color &baseColor, double diffuseFactor, double reflectivity, double refractivity, double refractiveIndex,
                                         const Component::Color &diffuse, double specular, double shininess)
        : Raytracer::AMaterial(REFLECTMATERIAL, refractivity, refractiveIndex, reflectivity, diffuseFactor, diffuse, specular, shininess), _baseColor(baseColor) {}
